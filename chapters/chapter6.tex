...
\begin{figure}
    \centering
    \includegraphics[height=0.19\textwidth]{largeflockNoLegend}
    \includegraphics[height=0.19\textwidth]{largeloneNoLegend}
    \includegraphics[height=0.19\textwidth]{herdflockNoLegend}
    \includegraphics[height=0.19\textwidth]{herdloneWithLegend}
...
\begin{figure}
    \includegraphics[width=0.75\textwidth]{large}
...
\begin{figure}
    \includegraphics[width=0.48\textwidth]{losing_influence}
...
\begin{figure}
    \centering
    \includegraphics[width=0.15\textwidth]{westgenetic01}
    \includegraphics[width=0.15\textwidth]{westgenetic02}
    \includegraphics[width=0.15\textwidth]{westgenetic03}
