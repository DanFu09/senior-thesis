...
opportunities to re-enter the screen and join a flock, and so flock formation
is rapid.
...
To evaluate these behaviors in a wider context, we then test them in the
\textit{large} and \textit{herd} settings as well.
