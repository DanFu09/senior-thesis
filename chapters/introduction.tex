...
study.
\S\ref{ch:genetic} discusses our approach to genetically evolving local
behaviors.
In \S\ref{ch:experiments}, we present our metrics and experimental frameworks,
and we present results in \S\ref{ch:results}.
