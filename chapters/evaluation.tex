...
\begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{largeflockNoLegend}
    \includegraphics[width=0.49\textwidth]{largeloneNoLegend}
    \includegraphics[width=0.49\textwidth]{herdflockNoLegend}
    \includegraphics[width=0.49\textwidth]{herdloneWithLegend}
...
\subsection{Influencing Agents in the Small Setting}
