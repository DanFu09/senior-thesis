...
this proportion of influencing agent that would not consistently break up the
flock.
...
can both maintain influence and influence Reynolds-Vicsek agents and so
...
however, the effects of losing influence are magnified.
\begin{figure}
...
We do now show \textit{coordinated}, since \textit{coordinated} is equivalent
...
None perform as well as the \textit{multistep} behavior, then $\textit{G1}$
comes close.
